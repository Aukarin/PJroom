    ...
    <input type="hidden" name="type_id" value="<?php echo $type_id; ?>" >
          ...
          <div class="form-group">
            <div class="col-sm-6" align="left">
              <input  name="type_name" type="text" required class="form-control" id="type_name" value="<?=$type_name;?>" placeholder="ชื่อ-สกุล" />
            </div>
          </div>

          <div class="form-group">
            <div class="col-sm-6" align="left">
              <input  name="t_detail" type="text" required class="form-control" id="t_detail" value="<?=$t_detail;?>" placeholder="รายละเอียด" />
            </div>
          </div>
