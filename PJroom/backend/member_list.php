      ...
      include('h.php');
                ...
                echo ' <table class="table table-hover">';
                  ...
                  echo "<tr>";
                    ...
                    //ลบข้อมูล
                    echo "<td><a href='member_del_db.php?ID1=$row[0]&ID2=$row[4]' onclick=\"return confirm('Do you want to delete this record? !!!')\" class='btn btn-danger btn-xs'>ลบ</a></td> ";
                  echo "</tr>";
                  }
                echo "</table>";
                //5. close connection
