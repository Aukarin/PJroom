        ...
        <div class="container" style="margin-top: 50px">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <h2><b> <?php echo "ห้อง " ;?><?php echo $row["p_name"];?></b></h2>
              <br> </br>
              <h3><p>
                ประเภท : <?php echo $row["type_name"];?>
              </p>
              <p>
                รายละเอียด : <?php echo $row["t_detail"];?>
              </p>
              ...
              <?php echo "ต่อคืน" ;?>
                ...
                if($row_pro['status_id'] == 1 ){
                  ?>
                  <a  class="btn btn-danger">ห้องเต็ม</a>
                  <?php
                }else{
                    ?>
                    
                 
                 <a href="client_form_add.php?id=<?php echo $row_pro['p_id'] ?>" class="btn btn-primary">จองห้อง</a>
                 <?php  }}?>
